...
Font F1("/dev_hdd0/game/UNOSTORES/USRDIR/data/fonts/header.ttf", Graphics), F2("/dev_hdd0/game/UNOSTORES/USRDIR/data/fonts/items.ttf", Graphics);
...
Printf PF("/dev_hdd0/game/UNOSTORES/USRDIR/data/log.txt");
