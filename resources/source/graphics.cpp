...
Font F1("/dev_hdd0/game/UNISTORES/USRDIR/data/fonts/header.ttf", Graphics), F2("/dev_hdd0/game/UNISTORES/USRDIR/data/fonts/items.ttf", Graphics);
...
Printf PF("/dev_hdd0/game/UNISTORES/USRDIR/data/log.txt");
...
u32 menu_text_color(int current, int selected, int choosed, int backups, int menu1_restore)
{
	...
	{
		if (choosed==1) return COLOR_ORANGE;
