...
int restore(string appfolder, string foldername)
{
		copy_prepare(appfolder, "restore", foldername, "", "");
		recursiveDelete("/dev_hdd0/game/UNOSTORES/USRDIR/backups");
		Graphics->AppExit();
...
s32 main(s32 argc, char* argv[])
{
	padInfo2 padinfo2;
	padData paddata;
	int menu_restore=-1, menu1_position=0, menu2_position=0, menu3_position=0, mpos=0, reboot=0, temp=0, current_menu=3, msize=0, choosed=0;
